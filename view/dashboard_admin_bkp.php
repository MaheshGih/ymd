					...
					<div class="media">
						...
						<div class="wigdet-two-content media-body">
							...
							<?php
								...
								$sql="SELECT * FROM `user_details' where is_active=1";
					...
					<div class="media">
						...
						<div class="wigdet-two-content media-body">
							...
							<?php
								...
								$sql="SELECT * FROM `user_details_old'";
		...
		<a href="#">
			<div class="card-box widget-box-two widget-two-custom">
				<div class="media">
					...
					<div class="wigdet-two-content media-body">
						<p class="m-0 text-uppercase font-weight-medium text-truncate"
							title="Statistics">Credit Withdraws History</p>
						<h3 class="font-weight-medium my-2">
							&#8377 <span data-plugin="counterup"><?php echo $wallet['total_amount']; ?></span>
						</h3>
						<p class="m-0">Till <?php echo date('d-m-Y'); ?></p>
		...
		<a href="reqwithdrawreport.php">
			<div class="card-box widget-box-two widget-two-custom">
				<div class="media">
					...
					<div class="wigdet-two-content media-body">
						<p class="m-0 text-uppercase font-weight-medium text-truncate"
							title="Statistics">Request Withdraws History</p>
						<h3 class="font-weight-medium my-2">
							&#8377 <span data-plugin="counterup"><?php echo $wallet['total_amount']; ?></span>
						</h3>
						<p class="m-0">Till <?php echo date('d-m-Y'); ?></p>
