                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title">Admin Reports</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title --> 
                            <div class="row">
                                <div class="col-12">
                                    <div class="card-box table-responsive">
                                        <h4 class="header-title"> All Users Details</h4>
                                        ...
                                        <thead>
                                            ...
                                            ?>
                                                <tr>
													...
													<td><?php echo $r['expired_date'];?></td>
													<td><?php echo $r['role'];?></td>
													<td><?php echo $r['kyc_done'];?></td>
													<td><?php echo $r['acc_name'];?></td>
													<td><?php echo $r['bank_name'];?></td>
													<td><?php echo $r['acc_no'];?></td>
													<td><?php echo $r['ifsc'];?></td>
													<td><?php echo $r['Gpay'];?></td>
													<td><?php echo $r['PhonePe'];?></td>
                                                    ...
                                                    <!--<td><a href="activate_process.php?id=<?php echo $r['id'];?>"><span class="badge label-table badge-danger">Activate</span></a></td>-->
                                                     <td><a href="activate_users.php?id=<?php echo $r['id'];?>"></a></td>   
													<td><?php echo $r['password'];?></td>
													<td><?php echo $r['txn_password'];?></td>
